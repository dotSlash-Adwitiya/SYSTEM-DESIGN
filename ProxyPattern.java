...
class CachedVideoDownloader implements VideoDownloader {
    ...
    // * <Key:Video_URL, Value: can be anything(Object)>
    ...
    public String downloadVideo(String videoUrl) {
        ...
        // * Put the newly fetch DB data into cache
...
class ProxyPattern {
    public static void main(String[] args) {
        ...
        // * No new instance created, for subsequent user, because video is already downloaded in cache
